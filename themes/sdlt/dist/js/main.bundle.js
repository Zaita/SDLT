...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "f0f4fbe6a515d72519a8";
...
function submitQuestionnaire(submissionID) {
  return (
    /*#__PURE__*/
    function () {
...
function batchUpdateSubmissionData(_x14, _x15) {
...
function _batchUpdateSubmissionData() {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee9(rootState, indexesToUpdate) {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch, props) {
  return {
    ...
    dispatchSubmitQuestionnaire: function dispatchSubmitQuestionnaire(submissionID) {
      dispatch(Object(_actions_questionnarie__WEBPACK_IMPORTED_MODULE_5__["submitQuestionnaire"])(submissionID));
    }
  };
};
...
function (_Component) {
  ...
  _createClass(ReviewContainer, [{
    ...
    value: function handleSubmitButtonClick() {
      var submission = this.props.submissionState.submission;
      ...
      if (_utils_SubmissionDataUtil__WEBPACK_IMPORTED_MODULE_7__["default"].existsUnansweredQuestion(submission.questions)) {
    ...
    value: function handleEditAnswerButtonClick() {
      var uuid = lodash__WEBPACK_IMPORTED_MODULE_9___default.a.get(this.props.submissionState, "submission.submissionUUID", "");

      if (!uuid) {
        return;
      }

      _utils_URLUtil__WEBPACK_IMPORTED_MODULE_10__["default"].redirectToQuestionnaireEditing(uuid);
    }
  }]);
...
/* harmony import */ var _AnswersPreview__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./AnswersPreview */ "./src/js/components/Questionnaire/AnswersPreview.js");
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! react-router-dom */ "./node_modules/react-router-dom/es/index.js");
/* harmony import */ var _img_icons_edit_svg__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../img/icons/edit.svg */ "./src/img/icons/edit.svg");
/* harmony import */ var _img_icons_edit_svg__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_img_icons_edit_svg__WEBPACK_IMPORTED_MODULE_6__);
...
function (_Component) {
  ...
  _createClass(Summary, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "Summary"
      }, this.renderSubmitterInfo(submission), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "answers"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", null, "Answers")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_AnswersPreview__WEBPACK_IMPORTED_MODULE_4__["default"], {
        submission: submission
      }), this.renderApprovals(submission), this.renderButtons(submission));
    }
  }, {
    ...
    value: function renderTasks(tasks) {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "tasks"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", null, "Tasks"), tasks.map(function (task) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          key: task.name
    ...
    value: function renderButtons(submission) {
      var _this$props2 = _objectSpread({}, this.props),
          ...
          handlePDFDownloadButtonClick = _this$props2.handlePDFDownloadButtonClick; // Display buttons for submitter when status is "submitted"


      var editAnswersButton = null;
      var sendForApprovalButton = null;

      if (viewAs === "submitter") {
        editAnswersButton = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Button_LightButton__WEBPACK_IMPORTED_MODULE_1__["default"], {
          title: "EDIT ANSWERS",
          iconImage: _img_icons_edit_svg__WEBPACK_IMPORTED_MODULE_6___default.a,
          classes: ["button"],
          disabled: true
        });

        if (submission.status === "submitted") {
          sendForApprovalButton = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Button_DarkButton__WEBPACK_IMPORTED_MODULE_2__["default"], {
      ...
      if (viewAs === "approver") {
        approveButton = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Button_DarkButton__WEBPACK_IMPORTED_MODULE_2__["default"], {
          title: "APPROVE",
          classes: ["button"],
          onClick: function onClick() {}
        });
        denyButton = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Button_LightButton__WEBPACK_IMPORTED_MODULE_1__["default"], {
          title: "DENY",
          classes: ["button"],
          onClick: function onClick() {}
        });
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "buttons"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, editAnswersButton, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Button_LightButton__WEBPACK_IMPORTED_MODULE_1__["default"], {
        title: "DOWNLOAD PDF",
        iconImage: _img_icons_pdf_svg__WEBPACK_IMPORTED_MODULE_3___default.a,
        classes: ["button"],
        onClick: handlePDFDownloadButtonClick
      }), sendForApprovalButton), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, approveButton, denyButton));
    }
  }, {
    key: "renderApprovals",
...
var mapDispatchToProps = function mapDispatchToProps(dispatch, props) {
  return {
    ...
    dispatchSubmitForApproval: function dispatchSubmitForApproval(submissionID) {
...
function (_Component) {
  ...
  _createClass(SummaryContainer, [{
    ...
    value: function render() {
      ...
      var viewAs = "others"; // Check if the current user is the submitter, perhaps change to use ID instead of email
            ...
            switch (_context3.prev = _context3.next) {
              ...
              case 11:
                ...
                data = {
                  ...
                  user: {
                    id: _utils_StringUtil__WEBPACK_IMPORTED_MODULE_3__["default"].toString(lodash__WEBPACK_IMPORTED_MODULE_1___default.a.get(memberData, "ID")),
                    name: "".concat(lodash__WEBPACK_IMPORTED_MODULE_1___default.a.get(memberData, "FirstName"), " ").concat(lodash__WEBPACK_IMPORTED_MODULE_1___default.a.get(memberData, "Surname")),
                    role: lodash__WEBPACK_IMPORTED_MODULE_1___default.a.get(memberData, "UserRole"),
                    email: lodash__WEBPACK_IMPORTED_MODULE_1___default.a.get(memberData, "Email")
                  },
                  submission: {
                    ...
                    submitter: {
                      id: _utils_StringUtil__WEBPACK_IMPORTED_MODULE_3__["default"].toString(lodash__WEBPACK_IMPORTED_MODULE_1___default.a.get(submissionJSON, "User.ID")),
                    ...
                    status: status,
                    approvalStatus: {
                      chiefInformationSecurityOfficer: _utils_StringUtil__WEBPACK_IMPORTED_MODULE_3__["default"].toString(lodash__WEBPACK_IMPORTED_MODULE_1___default.a.get(submissionJSON, "CisoApprovalStatus", "")),
                      businessOwner: _utils_StringUtil__WEBPACK_IMPORTED_MODULE_3__["default"].toString(lodash__WEBPACK_IMPORTED_MODULE_1___default.a.get(submissionJSON, "BusinessOwnerApprovalStatus", "")),
                      securityArchitect: _utils_StringUtil__WEBPACK_IMPORTED_MODULE_3__["default"].toString(lodash__WEBPACK_IMPORTED_MODULE_1___default.a.get(submissionJSON, "SecurityArchitectApprovalStatus", ""))
                    },
        ...
        return regeneratorRuntime.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 4:
                json = _context6.sent;
                status = _utils_StringUtil__WEBPACK_IMPORTED_MODULE_3__["default"].toString(lodash__WEBPACK_IMPORTED_MODULE_1___default.a.get(json, "data.updateQuestionnaireStatusToSubmitted.QuestionnaireStatus", null));
                uuid = _utils_StringUtil__WEBPACK_IMPORTED_MODULE_3__["default"].toString(lodash__WEBPACK_IMPORTED_MODULE_1___default.a.get(json, "data.updateQuestionnaireStatusToSubmitted.UUID", null));
              ...
              case 9:
                ...
                throw new Error("Submit questionnaire failed, the status is ".concat(status));
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                query = "\nmutation {\n updateQuestionnaireStatusToWaitingForApproval(ID: \"".concat(submissionID, "\") {\n   QuestionnaireStatus\n   UUID\n }\n}");
                _context7.next = 4;
                return _utils_GraphQLRequestHelper__WEBPACK_IMPORTED_MODULE_0__["default"].request({
                  query: query,
                  csrfToken: csrfToken
              ...
              case 4:
                json = _context7.sent;
                status = _utils_StringUtil__WEBPACK_IMPORTED_MODULE_3__["default"].toString(lodash__WEBPACK_IMPORTED_MODULE_1___default.a.get(json, "data.updateQuestionnaireStatusToWaitingForApproval.QuestionnaireStatus", null));
                uuid = _utils_StringUtil__WEBPACK_IMPORTED_MODULE_3__["default"].toString(lodash__WEBPACK_IMPORTED_MODULE_1___default.a.get(json, "data.updateQuestionnaireStatusToWaitingForApproval.UUID", null));
              ...
              case 9:
                ...
                throw new Error("Submit questionnaire for approval failed, the status is ".concat(status));
                ...
                questions.forEach(function (question, index) {
                  ...
                  if (question.type === "input" && question.inputs && Array.isArray(question.inputs)) {
                    question.inputs.forEach(function (input, index, arr) {
                      ...
                      content.push({
                        text: "".concat(input.label, ": ").concat(_StringUtil__WEBPACK_IMPORTED_MODULE_3__["default"].toString(data)),
