...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "8329432489849593dcb6";
...
/*!**************************************************!*\
  !*** ./src/js/actions/securityRiskAssessment.js ***!
  \**************************************************/
/*! exports provided: loadSecurityRiskAssessment */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _SecurityRiskAssessment_SecurityRiskAssessmentContainer_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../SecurityRiskAssessment/SecurityRiskAssessmentContainer.js */ "./src/js/components/SecurityRiskAssessment/SecurityRiskAssessmentContainer.js");
  ...
  _createClass(MainApp, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("main", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_1__["Switch"], null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_1__["Route"], {
        ...
        if (location.search) {
          var queryString = Object(query_string__WEBPACK_IMPORTED_MODULE_15__["parse"])(location.search);
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: "gray-bg"
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ComponentSelection_ComponentSelectionStandaloneContainer__WEBPACK_IMPORTED_MODULE_9__["default"], {
          taskId: match.params.taskId,
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: "gray-bg"
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_SecurityRiskAssessment_SecurityRiskAssessmentContainer_js__WEBPACK_IMPORTED_MODULE_14__["default"], {
          uuid: match.params.uuid,
          secureToken: secureToken
        }));
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_1__["Route"], {
...
/***/ "./src/js/components/Common/LikelihoodLegendContainer.js":
/*!***************************************************************!*\
  !*** ./src/js/components/Common/LikelihoodLegendContainer.js ***!
  \***************************************************************/
/*! exports provided: default */
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", {
          ...
          style: {
            backgroundColor: '#' + likelihoodThreshold.colour
          }
...
/***/ "./src/js/components/Common/RiskAssessmentMatrixTableContainer.js":
/*!************************************************************************!*\
  !*** ./src/js/components/Common/RiskAssessmentMatrixTableContainer.js ***!
  \************************************************************************/
/*! exports provided: default */
...
function (_Component) {
  ...
  _createClass(RiskAssessmentMatrixTableContainer, [{
     ...
     * @return object
     */
    value: function lookupLikelihood(sourceArray, weightedImpactScore) {
      var output = {}; // the use of `for ( let i of array)` is intentional. The loop needs to be
      ...
      try {
        for (var _iterator = sourceArray[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var likelihood = _step.value;
          var thresholdValue = +likelihood.value,
              likelihoodImpactScore = parseInt(weightedImpactScore);

          switch (likelihood.operator) {
            case '<=':
              if (_utils_Comparators__WEBPACK_IMPORTED_MODULE_2__["default"].lte(likelihoodImpactScore, thresholdValue)) {
                return likelihood;
              }
            ...
            case '<':
              if (_utils_Comparators__WEBPACK_IMPORTED_MODULE_2__["default"].lt(likelihoodImpactScore, thresholdValue)) {
                return likelihood;
              }
            ...
            case '>':
              if (_utils_Comparators__WEBPACK_IMPORTED_MODULE_2__["default"].gt(likelihoodImpactScore, thresholdValue)) {
                return likelihood;
              }
            ...
            case '>=':
              if (_utils_Comparators__WEBPACK_IMPORTED_MODULE_2__["default"].gte(likelihoodImpactScore, thresholdValue)) {
                return likelihood;
              }
    ...
    key: "sumOfLikelihoodWeightsForRisk",
    value: function sumOfLikelihoodWeightsForRisk(arrayOfRiskControls) {
      var sumOfLikelihoodWeights = 0;
      arrayOfRiskControls.map(function (control, index) {
    ...
    key: "baseImpactScore",
    value: function baseImpactScore(rawScore) {
    ...
    key: "combinedResults",
    value: function combinedResults(riskResults, likelihoodThresholds) {
      var _this = this;

      riskResults.map(function (r, i) {
        riskResults[i].baseImpactScore = _this.baseImpactScore(r.score);
        riskResults[i].sumOfLikelihoodWeightsForRisk = _this.sumOfLikelihoodWeightsForRisk([] //TODO: array of controls expected
        );
        riskResults[i].likelihood = _this.lookupLikelihood(likelihoodThresholds, _constants_values__WEBPACK_IMPORTED_MODULE_1__["DEFAULT_SRA_MATRIX_THRESHOLD_SCORE"] - riskResults[i].sumOfLikelihoodWeightsForRisk);
        riskResults[i].impact = _this.lookupLikelihood(likelihoodThresholds, riskResults[i].baseImpactScore);
      });
      return riskResults;
    }
    /**
    ...
    value: function render() {
      ...
      var combinedResults = this.combinedResults(riskResults, likelihoodThresholds);
      ...
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("th", null, "Risk"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("th", null, "Current Controls"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("th", null, "Current Likelihood"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("th", null, "Current Impact"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("th", null, "Current Risk Rating"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("th", null, "Recommended Treatments"))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tbody", null, combinedResults.map(function (riskResult, index) {
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", {
          key: index + 1
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", null, " ", riskResult.riskName, " ", riskResult.baseImpactScore ? ' (' + riskResult.baseImpactScore + ')' : '', " "), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", null, "  "), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", {
          style: {
            color: '#' + riskResult.likelihood.colour
          }
        }, "  ", riskResult.likelihood.name ? riskResult.likelihood.name + ' (' + riskResult.likelihood.value + ')' : '', " "), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", {
          style: {
            color: '#' + riskResult.impact.colour
          }
        }, "  ", riskResult.impact.name ? riskResult.impact.name + ' (' + riskResult.baseImpactScore + ')' : '', " "), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", {
          style: {
            backgroundColor: '#' + riskResult.colour
          }
        }, " ", riskResult.rating, " "), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", null, "  "));
      })))));
    }
  }]);
...
/* harmony import */ var _img_icons_edit_svg__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../../img/icons/edit.svg */ "./src/img/icons/edit.svg");
/* harmony import */ var _img_icons_edit_svg__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(_img_icons_edit_svg__WEBPACK_IMPORTED_MODULE_13__);
/* harmony import */ var _Button_LightButton__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../Button/LightButton */ "./src/js/components/Button/LightButton.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var mapDispatchToProps = function mapDispatchToProps(dispatch, props) {
  return {
    ...
    dispatchSaveLocalControlsAction: function dispatchSaveLocalControlsAction() {
      dispatch(Object(_actions_task__WEBPACK_IMPORTED_MODULE_12__["saveSelectedComponents"])(""));
    },
    ...
    dispatchEditAnswersAction: function dispatchEditAnswersAction() {
      dispatch(Object(_actions_task__WEBPACK_IMPORTED_MODULE_12__["editCompletedTaskSubmission"])({
        type: "componentSelection"
      }));
    }
  };
      ...
      switch (taskSubmission.status) {
        ...
        case "in_progress":
          body = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ComponentSelection__WEBPACK_IMPORTED_MODULE_7__["default"], {
            ...
            extraButtons: [react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Button_DarkButton__WEBPACK_IMPORTED_MODULE_11__["default"], {
              ...
              onClick: function onClick() {
                _utils_URLUtil__WEBPACK_IMPORTED_MODULE_9__["default"].redirectToQuestionnaireSummary(taskSubmission.questionnaireSubmissionUUID, secureToken);
              }
            })],
        ...
        case "complete":
          body = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ComponentSelectionReview__WEBPACK_IMPORTED_MODULE_10__["default"], {
            ...
            }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Button_LightButton__WEBPACK_IMPORTED_MODULE_14__["default"], {
              title: "EDIT CONTROLS",
              onClick: dispatchEditAnswersAction,
              classes: ["button"],
              iconImage: _img_icons_edit_svg__WEBPACK_IMPORTED_MODULE_13___default.a
...
function (_React$Component) {
  ...
  _createClass(ControlInfo, [{
    ...
    value: function render() {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h4", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, name)), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, description));
    }
  }]);
  ...
  _createClass(LeftBar, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        var isSelected = _utils_ComponentSelectionUtil__WEBPACK_IMPORTED_MODULE_2__["default"].isComponentExists(component.id, selectedComponents);
        var isDisable = _utils_ComponentSelectionUtil__WEBPACK_IMPORTED_MODULE_2__["default"].isComponentSaved(component.id, selectedComponents, componentTarget) && componentTarget == "JIRA Cloud";
...
function (_Component) {
  ...
  _createClass(Summary, [{
    key: "hasUnfinishedTaskSubmissions",
    value: function hasUnfinishedTaskSubmissions(submission) {
      var taskSubmissions = submission.taskSubmissions,
          unfinished = false;
      taskSubmissions.forEach(function (submission, index) {
        var isSRA = submission.taskType === 'security risk assessment',
    ...
    value: function renderTasks(submission) {
      ...
      var unfinished = this.hasUnfinishedTaskSubmissions(submission),
          unfinishedTasksAlert = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "alert alert-warning"
      }, _constants_values__WEBPACK_IMPORTED_MODULE_9__["DEFAULT_SRA_UNFINISHED_TASKS_MESSAGE"]);
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "tasks"
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", null, "Tasks"), unfinished ? unfinishedTasksAlert : null, taskSubmissions.map(function (_ref) {
        var uuid = _ref.uuid,
...
/* harmony import */ var _actions_user__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../actions/user */ "./src/js/actions/user.js");
/* harmony import */ var _actions_siteConfig__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../actions/siteConfig */ "./src/js/actions/siteConfig.js");
/* harmony import */ var _Common_LikelihoodLegendContainer__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../Common/LikelihoodLegendContainer */ "./src/js/components/Common/LikelihoodLegendContainer.js");
/* harmony import */ var _Common_RiskAssessmentMatrixTableContainer__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../Common/RiskAssessmentMatrixTableContainer */ "./src/js/components/Common/RiskAssessmentMatrixTableContainer.js");
/* harmony import */ var _actions_securityRiskAssessment__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../actions/securityRiskAssessment */ "./src/js/actions/securityRiskAssessment.js");
/* harmony import */ var _utils_URLUtil__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../utils/URLUtil */ "./src/js/utils/URLUtil.js");
/* harmony import */ var _Button_DarkButton__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../Button/DarkButton */ "./src/js/components/Button/DarkButton.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var mapDispatchToProps = function mapDispatchToProps(dispatch, props) {
  return {
    dispatchLoadDataAction: function dispatchLoadDataAction(uuid, secureToken) {
      dispatch(Object(_actions_user__WEBPACK_IMPORTED_MODULE_5__["loadCurrentUser"])());
      dispatch(Object(_actions_siteConfig__WEBPACK_IMPORTED_MODULE_6__["loadSiteTitle"])());
      dispatch(Object(_actions_securityRiskAssessment__WEBPACK_IMPORTED_MODULE_9__["loadSecurityRiskAssessment"])({
        uuid: uuid,
        secureToken: secureToken
      }));
    }
...
function (_Component) {
  ...
  _createClass(SecurityRiskAssessmentContainer, [{
    ...
    value: function render() {
      ...
      var backButton = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Button_DarkButton__WEBPACK_IMPORTED_MODULE_11__["default"], {
        title: "BACK TO QUESTIONNAIRE SUMMARY",
        onClick: function onClick() {
          _utils_URLUtil__WEBPACK_IMPORTED_MODULE_10__["default"].redirectToQuestionnaireSummary(securityRiskAssessmentData.questionnaireSubmissionUUID, secureToken);
        }
      });
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Common_RiskAssessmentMatrixTableContainer__WEBPACK_IMPORTED_MODULE_8__["default"], {
        riskResults: securityRiskAssessmentData.riskResults,
        likelihoodThresholds: securityRiskAssessmentData.likelihoodRatings
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Common_LikelihoodLegendContainer__WEBPACK_IMPORTED_MODULE_7__["default"], {
        likelihoodThresholds: securityRiskAssessmentData.likelihoodRatings
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "buttons"
      }, backButton)), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Footer_Footer__WEBPACK_IMPORTED_MODULE_4__["default"], null));
    }
  }]);
...
/*!************************************!*\
  !*** ./src/js/constants/values.js ***!
  \************************************/
/*! exports provided: DEFAULT_SRA_MATRIX_THRESHOLD_SCORE, DEFAULT_SRA_UNFINISHED_TASKS_MESSAGE */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
  ...
  _createClass(SecurityRiskAssessmentTaskDataService, null, [{
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee(args) {
        var _args, uuid, secureToken, query, responseJSONObject, submissionJSONObject, riskResults, data;
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 8:
                riskResults = submissionJSONObject.QuestionnaireSubmission.RiskResultData;
                ...
                data = {
                  ...
                  submitter: _utils_UserParser__WEBPACK_IMPORTED_MODULE_4__["default"].parseUserFromJSON(lodash_get__WEBPACK_IMPORTED_MODULE_1___default()(submissionJSONObject, "Submitter")),
                  ...
                  likelihoodRatings: _utils_TaskParser__WEBPACK_IMPORTED_MODULE_5__["default"].parseLikelihoodJSONObject(lodash_get__WEBPACK_IMPORTED_MODULE_1___default()(submissionJSONObject, "LikelihoodRatings")),
...
function () {
  ...
  _createClass(ComponentSelectionUtil, null, [{
    ...
    value: function isComponentSaved(id, collection) {
      return collection.filter(function (component) {
        return component.id === id && component.isSaved;
      }).length > 0;
    }
  }]);
