        ...
        $fields->addFieldsToTab(
            ...
            [
                ...
                LiteralField::create(
                    ...
                    'Please use variable {$questionnaireName} for quesionnaire name, {$productName} for product name, {$approvalLink} for
        ...
        $fields->addFieldsToTab(
            ...
            [
                ...
                LiteralField::create(
                    ...
                    'Please use variable {$questionnaireName} for quesionnaire name and {$productName} for product name in the email body and subject.'
                )
            ]
        );
