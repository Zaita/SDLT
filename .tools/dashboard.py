...
- Redmine API key is a personal team-member's key passed into `tools/init.sh`
...
# Write the dashboard.json to user's home dir
with open(os.environ['HOME'] + '/dashboard.json', 'wb') as outfile:
